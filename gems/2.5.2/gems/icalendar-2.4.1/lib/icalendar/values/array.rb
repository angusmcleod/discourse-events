module Icalendar
  module Values
    class Array < Value
          ...
          if value.is_a? ::Array
            value.map do |v|
              if v.is_a? Icalendar::Values::Array
                Icalendar::Values::Array.new v.value,
                                             klass,
                                             v.ical_params,
                                             delimiter: v.value_delimiter
              elsif v.is_a? ::Array
      ...
      def params_ical
        value.each { |v| ical_params.merge! v.ical_params }
        super
      end

      def value_ical
        value.map do |v| v.value_ical end.join value_delimiter
      end
