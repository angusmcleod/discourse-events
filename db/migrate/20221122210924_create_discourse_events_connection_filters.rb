  ...
  def change
    create_table :discourse_events_connection_filters do |t|
      t.references :connection,
                   ...
                   index: false,
                   foreign_key: {
                     to_table: :discourse_events_connections,
                   }
    ...
    add_index :discourse_events_connection_filters,
              %i[query_column query_value],
              unique: true,
              name: :idx_events_connection_filter_column_value,
              if_not_exists: true
  end
end
