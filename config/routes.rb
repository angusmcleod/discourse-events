...
Discourse::Application.routes.prepend do
  ...
  scope module: "discourse_events", constraints: AdminConstraint.new do
    scope "/admin/plugins" do
      ...
      get "events/event/connection" => "connection#index"
      put "events/event/connection/new" => "connection#create"
      put "events/event/connection/:id" => "connection#update"
      post "events/event/connection/:id" => "connection#sync"
